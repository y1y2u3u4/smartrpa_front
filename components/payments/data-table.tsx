...
export function DataTable<TData, TValue>({
    ...
    const { excelData, setExcelData, shuruData, setShuruData } = useExcelData();
    ...
    // 获取第一个字段
    const firstField = columnNames[0];
    ...
    return (
        <div>
            <div className="flex items-center py-4">
                {/* <Input
                    placeholder="查找商品名..."
                    value={(table.getColumn(firstField)?.getFilterValue() as string) ?? ""}
                    onChange={(event) =>
